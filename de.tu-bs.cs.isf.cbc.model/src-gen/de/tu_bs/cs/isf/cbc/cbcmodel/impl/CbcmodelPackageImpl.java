...
public class CbcmodelPackageImpl extends EPackageImpl implements CbcmodelPackage {
	...
	public void initializePackageContents() {
		...
		initEAttribute(getAbstractStatement_Id(), ecorePackage.getEString(), "id", "", 1, 1, AbstractStatement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
